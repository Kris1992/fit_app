 ...
 */
final class Version20200514155128 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE friend (id INT AUTO_INCREMENT NOT NULL, inviter_id INT NOT NULL, invitee_id INT NOT NULL, status VARCHAR(10) NOT NULL, INDEX IDX_55EEAC61B79F4F04 (inviter_id), INDEX IDX_55EEAC617A512022 (invitee_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
